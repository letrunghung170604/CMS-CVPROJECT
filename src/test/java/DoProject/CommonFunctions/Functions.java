...
public class Functions {
    ...
    public void CLearWE(WebElement Site)
    {
        Site.clear();
    }
    ...
    public String getTextBy(By Site)
    {
        return driver.findElement(Site).getText();
    }

    public String getAttributeBy(By Site, String ValueAttribute)
    {
        return driver.findElement(Site).getAttribute(ValueAttribute);
    }

    public void clickAtPositionAC(int x, int y) {
        Actions actions = new Actions(driver);
        actions.moveByOffset(x, y).click().perform();
        actions.moveByOffset(-x, -y).perform();
    }

    public void clickAtPositionJS(int x, int y) {
